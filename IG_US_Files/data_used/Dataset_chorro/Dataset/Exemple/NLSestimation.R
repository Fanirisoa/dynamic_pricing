...
para_h<-c(1,0.1,0,0.5,0,0)
para_h_star<-0.1
M = mapply(function(S,T,r1) MGF_P(u=1, para_h=para_h, Data.ret=Data.ret,S,T,r1) ,S=Data.contract$S,T=Data.contract$T,r1=Data.contract$r)
M
#MGF <- list()
#S=data$SJ[[1]]
#T=data$ttm[[1]]
