...
#####################################################
source("C:/Users/e0g411k03dt/Desktop/Simulation P3 Mars 2017/HN-GARCH/Gaussian Quadratic returns/Loglik Return HN sous Q Qua.R")
...
ts.vol= shape_vol(para_h, Data.returns) 
