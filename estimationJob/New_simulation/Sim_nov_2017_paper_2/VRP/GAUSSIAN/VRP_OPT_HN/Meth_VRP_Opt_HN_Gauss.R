...
###    Load fonctions   #######
###############################
source("F:/Mai MSE 2017/Estimation P2 Mars 2017/VRP/GAUSSIAN/VRP_OPT_HN/VRP_VIX_HN_Gauss.R")

source("I:/Sim_nov_2017_paper_2/VRP/GAUSSIAN/VRP_OPT_HN/VRP_Opt_HN_Gauss.R")
