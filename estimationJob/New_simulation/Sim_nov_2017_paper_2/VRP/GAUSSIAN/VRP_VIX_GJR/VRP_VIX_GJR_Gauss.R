...
h_p_opt_gauss  <- function(para_h_Gauss, Data.returns)  
{
...
h_q_opt_gauss<-function(para_h_Gauss,Data.returns){
  rt=Data.returns$rt/250  
...
######     Conditional variance with risk netral Proba      ##
##############################################################
VRP_opt_gauss<-function(para_h_opt_gauss,Data.returns){
  rt=Data.returns$rt/250  
  ret=Data.returns$ret         #### Returns : Data.BSJ$ret
  Z1=length(ret)
  ...
  h_1=h_p_opt_gauss(para_h_Gauss,Data.returns)
  h_2=h_q_opt_gauss(para_h_Gauss,Data.returns)
