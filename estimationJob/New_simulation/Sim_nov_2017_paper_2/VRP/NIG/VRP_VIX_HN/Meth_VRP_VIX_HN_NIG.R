...
source("C:/Users/e0g411k03dt/Desktop/Sim_nov_2017_paper_2/VRP/NIG/VRP_VIX_HN/VRP_VIX_HN_NIG.R")
...
plot(as.Date(df_VRP_vix_NIG$date), Data.plot_p_vix_NIG$ts.vol_p_vix_NIG, xlab= "Time", ylab= "(h,h*) values", type='l', col='red', xlim=c(as.Date('1999-10-01'),as.Date('2009-9-30')), ylim=c(-0.001,0.001)) 
