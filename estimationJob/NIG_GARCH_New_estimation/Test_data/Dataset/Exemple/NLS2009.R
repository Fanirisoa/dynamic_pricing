...
Serie.data <- setNames(lapply(1:1, function(s) Data.function(s)),paste0("d_", 1:1))  
...
MGF_Q<-function(u,para_h,para_h_star,Data.ret,Data.contract){
    T=Data.contract$T       ####  Time to maturity expressed in terms of years in terms of days
    S=Data.contract$S       ####  Prix du sous-jacent: Data.contract$S
    K=Data.contract$K       ####  Strike  Prix d'exercice: data$strike
    r1=Data.contract$r      ####  Interest rate Data.contract$r  
...
## W3<-MGF_Q(u=0.08, para_h=para_h,para_h_star=para_h_star, Data.contract=Data.contract)
...
FC_Q<-function(u, para_h ,para_h_star,Data.ret ,Data.contract){
  ...
  FC_Q=  MGF_Q(u_Complex, para_h=para_h,para_h_star=para_h_star, Data.ret=Data.ret,Data.contract=Data.contract)
...
############################################################
rmse <- function(para_h,para_h_star,Data.ret,Data.contract)
{  
 
  C=Data.contract$C       ####  Call price
  P<-Price_fft(para_h=para_h,para_h_star=para_h_star,Data.ret=Data.ret,Data.contract=Data.contract)
  V<-vega_call(Data.contract=Data.contract,type="C")
...
start.time <- Sys.time()
rmse( para_h=para_h,para_h_star=para_h_star,Data.ret=Data.ret,Data.contract=Data.contract)
end.time <- Sys.time()
time.taken <- end.time - start.time
time.taken
...
############################################################
para_h_star<-c(-0.1,-0.2)
rmse1 <- function(para_h,Data.ret,Data.contract)
{  
  C=Data.contract$C       ####  Call price
  P<-Price_fft(para_h=para_h,para_h_star=para_h_star,Data.ret=Data.ret,Data.contract=Data.contract)
  V<-vega_call(Data.contract=Data.contract,type="C")
...
para=c(0.1,0.1,0,0.5,0,0.5)
NLS_estim=optim(par=para,fn=rmse1,Data.ret=Data.ret,Data.contract=Data.contract,method="L-BFGS-B",lower=c(-11,-12,-13,-14,-15,-16), upper=c(11,12,13,14,15))
