...
#####################################################
source("C:/Users/fanir/Desktop/Simulation_juin2018/NGARCHbis/N Esscher returns/NGARCH_returns_loglike.R")
...
para_h<-c(1.603e-06 , 0.8447  ,0.06175 , 1.146, 0.03736)  ## RMSE2$rmse :    RMSE3$rmse :  0.04541123

para_h<-c(2.157e-03 , 0.6358  ,0.0954 , 0.545, 0.08762 )
###   Solution 
para_h<-c(1.157e-03 , 0.5358  ,0.0954 , 0.745, 0.08762 )  ## RMSE2$rmse :    RMSE3$rmse :  0.007396033
...
source("C:/Users/fanir/Desktop/Simulation_juin2018/NGARCHbis/N Esscher returns/Simulation_MC_Pricer_return_NGARCH.r")
source("C:/Users/fanir/Desktop/Simulation_juin2018/NGARCHbis/N Esscher returns/Function_Pricer_return_NGARCH.r")
source("C:/Users/fanir/Desktop/Simulation_juin2018/NGARCHbis/N Esscher returns/NGARCH_returns_loglike.R")
...
####                        RMSE                          ##
############################################################
source("C:/Users/fanir/Desktop/Simulation_juin2018/NGARCHbis/N Esscher returns/RMSES_return_NGARCH.R")
start.time <- Sys.time()
...
####                       Compare VIX                    ##
############################################################
source("C:/Users/fanir/Desktop/Simulation_juin2018/NGARCHbis/N Esscher returns/Comparing_VIX_ret_Ess.R")
