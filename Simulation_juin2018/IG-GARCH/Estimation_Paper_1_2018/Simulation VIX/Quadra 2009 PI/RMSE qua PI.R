...
Price_fft<-function(para_h,Data.ret,Data.contract){
  S=Data.contract$S       ####  Prix du sous-jacent: Data.contract$S
  K=Data.contract$K       ####  Strike  Prix d'exercice: data$strike
  Mod=Data.contract$Mod   ####  Class of equivalence
...
{  
  T=Data.contract$T*250   ####  Time to maturity expressed in terms of years in terms of days
  S=Data.contract$S       ####  Prix du sous-jacent: Data.contract$S
  K=Data.contract$K       ####  Strike  Prix d'exercice: data$strike
  r=Data.contract$r/250   ####  Interest rate Data.contract$r
...
############################################################
MSE <- function(para_h,Data.ret,Data.contract)
{  
  C=Data.contract$C       ####  Call price
...
RMSE <- function(para_h,Data.ret,Data.contract)
{  
  C=Data.contract$C       ####  Call price
  P<-Price_fft(para_h=para_h,Data.ret=Data.ret, Data.contract=Data.contract)
