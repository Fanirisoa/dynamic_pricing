...
h<-function(para_h,Data.returns){
  ...
  if (c<=0){drapeau=1}
  if (neta>=0){drapeau=1}
  if (PI<=1.000001e+00){drapeau=1}
  if (nu<=0){drapeau=1}
  if (ro<=0){drapeau=1}
  if (ro>=1){drapeau=1}
  if (g0<=0.8555){drapeau=1}
  #if (g0>=0.9686){drapeau=1}
  #if (g1<=0.9786){drapeau=1}
  if (g1>=0.9996){drapeau=1}
  if (g1<=g0-0.0081){drapeau=1}
