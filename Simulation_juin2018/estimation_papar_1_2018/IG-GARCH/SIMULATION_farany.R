...
#####################################################
source("C:/Users/fanir/Desktop/Simulation_juin2018/estimation_papar_1_2018/IG-GARCH/IG_Esscher_returns_VIX/LoglikReturn.R")
source("C:/Users/fanir/Desktop/Simulation_juin2018/estimation_papar_1_2018/IG-GARCH/IG_Esscher_returns_VIX/Loglik_VIX_lin.r")
source("C:/Users/fanir/Desktop/Simulation_juin2018/estimation_papar_1_2018/IG-GARCH/IG_Esscher_returns_VIX/LogMixte.r")
...
PLAL<-function(para_h){
  ...
  P0=(a*((neta)^2))+b+(c/((neta)^2))
  L0=(c/neta)- ((neta)^3)*a
  
  return(list(PI,P,L,P0,L0)) 
}
