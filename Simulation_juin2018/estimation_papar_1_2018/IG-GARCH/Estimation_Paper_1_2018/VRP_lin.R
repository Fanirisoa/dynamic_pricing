...
para_h_lin<-c(4.0781e-06 , 1.2642e-03  ,3.3177e+03 , 5.0538e-05, -8.2753e-03 , 1.212284e+02)

## para_h_lin<-c(6.5759e-06,1.4019e-03,3.0174e+03,5.1407e-05, -8.252e-03,1.2122e+02)

## para_h_lin = c(4.238940e-06 , 2.058376e-03  ,3.317425e+03 , 5.058743e-05, -8.281782e-03 , 1.2584e+02 )
...
h_p_lin <- function(para_h_lin, Data.returns) {
...
##############################################################
h_q_lin<-function(para_h_lin,Data.returns){
  ##rt=Data.returns$rt/250     
  rt=(0.05+ Data.returns$rt - Data.returns$rt)    
...
######     Conditional variance with risk netral Proba      ##
##############################################################
VRP_lin<-function(para_h_lin,Data.returns){
  ##rt=Data.returns$rt/250     
  rt=(0.05+ Data.returns$rt - Data.returns$rt)     
  ret=Data.returns$ret         #### Returns : Data.BSJ$ret
  Z1=length(ret)
  ...
  h_1=h_p_lin(para_h_lin,Data.returns)
  h_2=h_q_lin(para_h_lin,Data.returns)
