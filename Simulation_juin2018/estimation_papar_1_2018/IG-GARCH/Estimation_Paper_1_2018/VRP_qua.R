...
para_h_qua<-c( 1.993036e-06 , 6.446413e-01  ,6.745918e+02,  8.488463e-06, -5.032286e-03 , 1.944558e+02  ,1.313840e+00)
...
h_p_qua <- function(para_h_qua, Data.returns) {
...
####################################################
h_q_qua<-function(para_h_qua,Data.ret){
  # rt=Data.returns$rt/250     
  rt=(0.05+ Data.returns$rt - Data.returns$rt)    
...
######     Conditional variance with risk netral Proba      ##
##############################################################
VRP_qua<-function(para_h_qua,Data.returns){
  # rt=Data.returns$rt/250     
  rt=(0.05+ Data.returns$rt - Data.returns$rt)     
  ...
  h_1=h_p_qua(para_h_qua,Data.returns)
  h_2=h_q_qua(para_h_qua,Data.returns)
