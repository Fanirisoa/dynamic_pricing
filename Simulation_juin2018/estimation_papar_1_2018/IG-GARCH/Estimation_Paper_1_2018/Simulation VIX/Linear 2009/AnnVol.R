...
Vol2009=ht(para_h1,Data.ret.2009)

ts.plot(Vol2009, col = "steelblue", main = "IG Garch Model",xlab="2009",ylab="Volatility")
anVol=(252*(Vol2009))^(1/2)
ts.plot(anVol, col = "steelblue", main = "IG Garch Model",xlab="2009",ylab="Volatility")
mean(anVol)

acv=0.5*100*(494*(ts.vol))^(1/2)
mean(acv)
494*(var(ts.vol))^(1/2)
grid()