...
Serie.data <- setNames(lapply(1:172 , function(s) Data.function(s)),paste0("d_", 1:172))  
...
Data.contract<-data.frame(C=Data.contract$C,K=Data.contract$K,S=Data.contract$S,T=Data.contract$T,r=Data.contract$r,d=Data.contract$d )
...
Data.new<-data.frame(C=Data.contract$C,K=Data.contract$K,S=Data.contract$S,T=Data.contract$T,r=Data.contract$r,d=Data.contract$d,CsK)
...
Serie.dataBSJ <- setNames(lapply(2172:5591, function(s) Data.transf(s)),paste0("d_", 2172:5591))  
...
##########################################
Serie.dataBSJ.ret <- setNames(lapply(2172:5591, function(s) Data.transf(s)),paste0("d_", 2172:5591))  
