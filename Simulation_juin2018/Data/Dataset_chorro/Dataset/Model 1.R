...
MGF_P<-function(u,para_h ,Data.contract){
...
## M = MGF_P(u=0.002, para_h=para_h, Data.contract=Data.contract)
## M
...
FC_P<-function(u,para_h ,Data.contract){
  # Complex number : 
  u_Complex=1i*u 
  
  FC_P= MGF_P(u_Complex, para_h=para_h, Data.contract=Data.contract)
  
  return(FC_P)
  
}

## M=FC_P(u=0.002,para_h=para_h,Data.contract=Data.contract)
M
M-M1####################################################
...
## para_h<-c(1,-0.001,0,0.5,0,0,-0.1,0.2)
## W3<-MGF_Q(u=0.08, para_h=para_h,Data.contract=Data.contract)
...
## start.time <- Sys.time()
## FC_Q(u=0.002, para_h,Data.contract)
## end.time <- Sys.time()
