...
Data.Not=Data.N1[-c(85,115,146,198,203,356,376,404,440,462,488,519,568,618,665,701,756,780,861,1049,1056,1073,1102,1153,1177,1297),]
...
#####################################################
save(Data.ret,Data.N,Data.Not,Data.returns, file="DataPrice2009.Rdata")
